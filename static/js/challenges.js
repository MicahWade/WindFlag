        ...
        .then(data => {
            ...
            data.forEach(category => {
                ...
                category.challenges.forEach(challenge => {
                    ...
                    challengesHtml += `
                        <div class="theme-challenge-card theme-hover-card p-6 challenge-card cursor-pointer transform hover:scale-105 transition duration-300 ease-in-out ${challenge.solved ? 'theme-completed-challenge completed-challenge-line' : ''} ${challenge.expired ? 'opacity-75' : ''}"
                             ...
                             data-expired="${challenge.expired}">
