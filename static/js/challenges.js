document.addEventListener('DOMContentLoaded', function() {
    ...
    let fullscreenEditor = null; // To keep track of the editor in fullscreen mode for user challenges
    ...
    // Handle Escape key to exit fullscreen for user challenges
                    ...
                    .then(data => {
                        ...
                        if (data.challenge_type === 'CODING') {
                            ...
                            if (!codeMirrorEditor) {
                                ...
                                // Add fullscreen button to the newly created CodeMirror instance
                                const fullscreenButton = createFullscreenButton(codeMirrorEditor);
                            ...
                            if (codeMirrorEditor) {
                                ...
                                // Reset fullscreenEditor if it was referring to this instance
                                if (fullscreenEditor === codeMirrorEditor) {
                                    fullscreenEditor = null;
                                    document.body.style.overflow = ''; // Restore body scrollbar if exiting fullscreen
                                }
                            }
